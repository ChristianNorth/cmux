...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.sidebarAppearance, "show-agent-sessions", String(localized: "settings.app.showAgentSessions", defaultValue: "Show Agent Sessions"), "sidebar.showAgentSessions agent session rows claude codex title prompt age"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "sidebar.showAgentSessions": settingID(for: .sidebarAppearance, idSuffix: "show-agent-sessions"),
